                ...
                <div className="content">
                    ...
                    <div className="column">
                        ...
                        <div className="meter-intro">
                            <h5>Grapje?</h5>
                            <p>
                                <b>De link is beoordeeld als <small>Neutraal</small>.</b><br />Deze module is nog te onbetrouwbaar voor advies.<br /><small>Waarom is dit een neutraal?</small>
                            </p>
                        </div>
                    </div>
                    <div className="column">
                        ...
                        <div className="meter-intro">
                            <h5>Gevaarlijk?</h5>
                            <p>
                                <b>De link is beoordeeld als <small>Neutraal</small>.</b><br />Deze module is nog te onbetrouwbaar voor advies.<br /><small>Waarom is dit neutraal?</small>
                            </p>
                        </div>
                    </div>
